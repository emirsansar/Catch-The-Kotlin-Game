...
class UserProfileViewModel(application: Application): BaseViewModel(application) {
    ...
    fun fetchUserProfileInfoFromDB(userEmail: String, callback: (UserProfile?) -> Unit?){
        launch {
    ...
    fun setUserProfileInfoToRoomDB(userProfile: UserProfile){
        launch {
    ...
    fun changeUserProfilePictureUriOnDB(userEmail: String, uri: String){
        launch {
            AppDatabase(getApplication()).userProfileDAO().setProfilePictureUri(userEmail, uri)
        }
    }
    ...
    fun getUserFullNameFromFirebase(userEmail: String, callback: (String) -> Unit){
    ...
    fun getUserFullNameFromDB(userEmail: String, callback: (String) -> Unit){
        launch {
